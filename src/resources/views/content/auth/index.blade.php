...
<head>
    ...
    <title>@lang('AvalonAdmin::Content/Auth.index.title')</title>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="/avalon-admin-assets/plugins/iCheck/square/blue.css">
...
<div class="login-box">
    <div class="login-logo">
        <a href="{!! url('') !!}">{!! config('avalon-admin.appName', '<b>Admin</b>LTE') !!}</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input type="checkbox"> @lang('AvalonAdmin::Content/Auth.index.remember')
                        </label>
                    </div>
                </div>
                <!-- /.col -->
                <div class="col-xs-4">
                    <button type="submit" class="btn btn-primary btn-block btn-flat">@lang('AvalonAdmin::Content/Auth.index.signIn')</button>
                </div>
                <!-- /.col -->
            </div>
        </form>
        ...
        <a href="#">@lang('AvalonAdmin::Content/Auth.index.forgotPassword')</a>
...
<!-- iCheck -->
<script src="/avalon-admin-assets/plugins/iCheck/icheck.min.js"></script>
<script>
    $(function () {
        $('input').iCheck({
